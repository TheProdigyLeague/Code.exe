...
```
### Using massdns to resolve "AltDNS"
```powershell
...
```
默认。有效载荷。跑步！
# [Can I Take Over "xyz"?](https://github.com/EdOverflow/can-i-take-over-xyz) by EdOverflow for a list of services and how to claim (sub)domains with dangling DNS records.
>>>import tko-subs
```powershell
