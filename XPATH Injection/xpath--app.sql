# XPATH injection
> XPath Injection is an attack technique used to exploit applications that construct XPath___xml__query_ from user-supplied input to query or navigate XML documents.
# Summary
