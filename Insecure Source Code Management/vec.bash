...
$- .git/HEAD
$- .git/logs/HEAD
### Example recovering file contents from .git/logs/HEAD
~
>>>for ["403"]; Forbidden 
>>>dir --list*find | `/.git/` --dir
$--Git -save ["all", 'info'] 
$`.git/logs/[h]HEAD
    ```powershell
...
$ docker run --rm --name=gitleaks -e GITHUB_TOKEN={your token} zricethezav/gitleaks --github-pr=https://github.com/owner/repo/pull/9000 #or 
$ go get -u  github.com/zricethezav/gitleaks
```
## Subversion, Example (Wordpress)
```powershell
