...
> Used to exploit (WBA) web based applications that construct LDAP statements based on user input...
> An application fails to properly sanitize user input. Mod LDAP statements using a Burp Suite--local proxy.
## Summary
